...
<div class="form-card">
    ...
    <form method="POST" action="{{ route('students.store') }}" enctype="multipart/form-data" data-warn-unsaved>
        @csrf
        ...
        <fieldset>
            ...
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <input type="file" id="field_student_passport_photo" name="student_passport_photo" class="form-control @error('student_passport_photo') is-invalid @enderror" accept="image/*">
                ...
                <div class="col-md-5">
                    ...
                    <input type="text" id="field_student_last_name" name="student_last_name" class="form-control @error('student_last_name') is-invalid @enderror" value="{{ old('student_last_name') }}" placeholder="Last Name" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" id="field_student_dob" name="student_dob" class="form-control" value="{{ old('student_dob') }}">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <select id="field_citizen_type" name="citizen_type" class="form-select">
                        <option value="">Select</option>
                        <option value="Birth" {{ old('citizen_type') == 'Birth' ? 'selected' : '' }}>Birth</option>
                        <option value="Descent" {{ old('citizen_type') == 'Descent' ? 'selected' : '' }}>Descent</option>
                        <option value="Naturalisation" {{ old('citizen_type') == 'Naturalisation' ? 'selected' : '' }}>Naturalisation</option>
                    </select>
                </div>

                <div class="col-md-3">
                    <label class="form-label" for="field_student_birth_certificate_pin">Birth Certificate PIN</label>
                    <input type="text" id="field_student_birth_certificate_pin" name="student_birth_certificate_pin" class="form-control @error('student_birth_certificate_pin') is-invalid @enderror" value="{{ old('student_birth_certificate_pin') }}" maxlength="20" placeholder="Birth Cert PIN">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="field_student_religion" name="student_religion" class="form-control" value="{{ old('student_religion') }}" placeholder="Religion">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_country_of_birth">Country of Birth</label>
                    <input type="text" id="field_student_country_of_birth" name="student_country_of_birth" class="form-control" value="{{ old('student_country_of_birth') }}" placeholder="Country of Birth">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_nationality">Nationality</label>
                    <input type="text" id="field_student_nationality" name="student_nationality" class="form-control" value="{{ old('student_nationality') }}" placeholder="Nationality">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_ethnicity">Ethnicity</label>
                    <input type="text" id="field_student_ethnicity" name="student_ethnicity" class="form-control" value="{{ old('student_ethnicity') }}" placeholder="Ethnicity">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_contact">Contact Number</label>
                    <input type="tel" inputmode="tel" id="field_student_contact" name="student_contact" class="form-control" value="{{ old('student_contact') }}" placeholder="Contact No.">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_email">Email Address</label>
                    <input type="email" id="field_student_email" name="student_email" class="form-control" value="{{ old('student_email') }}" placeholder="Email">
                </div>
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <textarea id="field_student_current_address" name="student_current_address" class="form-control" rows="3" placeholder="Enter full current address">{{ old('student_current_address') }}</textarea>
                </div>
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="date" id="field_student_sea_date" name="student_sea_date" class="form-control" value="{{ old('student_sea_date') }}">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_primary_school">Primary School</label>
                    <input type="text" id="field_student_primary_school" name="student_primary_school" class="form-control" value="{{ old('student_primary_school') }}" placeholder="Primary School Name">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_sea_number">SEA Number</label>
                    <input type="text" id="field_student_sea_number" name="student_sea_number" class="form-control" value="{{ old('student_sea_number') }}" placeholder="SEA #">
                </div>
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <select id="field_student_transfer_status" name="student_transfer_status" class="form-select">
                        <option value="">Select</option>
                        <option value="Yes" {{ old('student_transfer_status') == 'Yes' ? 'selected' : '' }}>Yes</option>
                        <option value="No" {{ old('student_transfer_status') == 'No' ? 'selected' : '' }}>No</option>
                    </select>
                </div>

                <div class="col-md-3">
                    <label class="form-label" for="field_student_transfer_date">Transfer Date</label>
                    <input type="date" id="field_student_transfer_date" name="student_transfer_date" class="form-control" value="{{ old('student_transfer_date') }}">
                </div>

                <div class="col-md-3">
                    <label class="form-label" for="field_student_previous_form_class">Previous Form Class</label>
                    <input type="text" id="field_student_previous_form_class" name="student_previous_form_class" class="form-control" value="{{ old('student_previous_form_class') }}" placeholder="Previous Class">
                </div>

                <div class="col-md-3">
                    <label class="form-label" for="field_student_previous_secondary_school">Previous School</label>
                    <input type="text" id="field_student_previous_secondary_school" name="student_previous_secondary_school" class="form-control" value="{{ old('student_previous_secondary_school') }}" placeholder="Previous School">
                </div>

                <div class="col-md-12">
                    <label class="form-label" for="field_student_previous_school_location">Previous School Location</label>
                    <textarea id="field_student_previous_school_location" name="student_previous_school_location" class="form-control" rows="2" placeholder="Previous school address">{{ old('student_previous_school_location') }}</textarea>
                </div>

                <div class="col-md-12">
                    <label class="form-label" for="field_student_transfer_reason">Transfer Reason</label>
                    <textarea id="field_student_transfer_reason" name="student_transfer_reason" class="form-control" rows="2" placeholder="Reason for transfer">{{ old('student_transfer_reason') }}</textarea>
                </div>
        ...
        <fieldset>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <textarea id="field_student_medical_condition" name="student_medical_condition" class="form-control" rows="2" placeholder="Any medical conditions">{{ old('student_medical_condition') }}</textarea>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" id="field_student_immunization_status" name="student_immunization_status" class="form-control" value="{{ old('student_immunization_status') }}" placeholder="Immunization Status">
                </div>

                <div class="col-md-12">
                    <label class="form-label" for="field_student_allergies">Allergies</label>
                    <textarea id="field_student_allergies" name="student_allergies" class="form-control" rows="2" placeholder="Any allergies">{{ old('student_allergies') }}</textarea>
                </div>
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" id="field_student_family_crisis" name="student_family_crisis" class="form-control" value="{{ old('student_family_crisis') }}" placeholder="Family crisis if any">
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="field_student_receiving_counselling">Receiving Counselling</label>
                    <textarea id="field_student_receiving_counselling" name="student_receiving_counselling" class="form-control" rows="2" placeholder="Counselling details">{{ old('student_receiving_counselling') }}</textarea>
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="field_student_physical_disabilities">Physical Disabilities</label>
                    <textarea id="field_student_physical_disabilities" name="student_physical_disabilities" class="form-control" rows="2" placeholder="Physical disabilities if any">{{ old('student_physical_disabilities') }}</textarea>
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="field_student_learning_disabilities">Learning Disabilities</label>
                    <textarea id="field_student_learning_disabilities" name="student_learning_disabilities" class="form-control" rows="2" placeholder="Learning disabilities if any">{{ old('student_learning_disabilities') }}</textarea>
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="field_student_educational_aid">Educational Aid</label>
                    <input type="text" id="field_student_educational_aid" name="student_educational_aid" class="form-control" value="{{ old('student_educational_aid') }}" placeholder="Educational aid received">
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="field_student_special_sea_concessions">Special SEA Concessions</label>
                    <input type="text" id="field_student_special_sea_concessions" name="student_special_sea_concessions" class="form-control" value="{{ old('student_special_sea_concessions') }}" placeholder="SEA concessions">
                </div>

                <div class="col-md-12">
                    <label class="form-label" for="field_student_emotional_factors">Emotional/Developmental Factors</label>
                    <textarea id="field_student_emotional_factors" name="student_emotional_factors" class="form-control" rows="2" placeholder="Emotional or developmental factors">{{ old('student_emotional_factors') }}</textarea>
                </div>

                <div class="col-md-12">
                    <label class="form-label" for="field_student_other_intervention_information">Other Intervention Information</label>
                    <textarea id="field_student_other_intervention_information" name="student_other_intervention_information" class="form-control" rows="2" placeholder="Other intervention information">{{ old('student_other_intervention_information') }}</textarea>
                </div>
            </div>
        </fieldset>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select id="field_student_social_welfare_status" name="student_social_welfare_status" class="form-select">
                        <option value="">Select</option>
                        <option value="Yes" {{ old('student_social_welfare_status') == 'Yes' ? 'selected' : '' }}>Yes</option>
                        <option value="No" {{ old('student_social_welfare_status') == 'No' ? 'selected' : '' }}>No</option>
                    </select>
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_social_welfare_detail">Social Welfare Detail</label>
                    <input type="text" id="field_student_social_welfare_detail" name="student_social_welfare_detail" class="form-control" value="{{ old('student_social_welfare_detail') }}" placeholder="Details">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_mode_of_transport">Mode of Transport</label>
                    <input type="text" id="field_student_mode_of_transport" name="student_mode_of_transport" class="form-control" value="{{ old('student_mode_of_transport') }}" placeholder="Transport method">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_access_to_device">Access to Device</label>
                    <input type="text" id="field_student_access_to_device" name="student_access_to_device" class="form-control" value="{{ old('student_access_to_device') }}" placeholder="Device access">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select id="field_student_device_shared" name="student_device_shared" class="form-select">
                        <option value="">Select</option>
                        <option value="Yes" {{ old('student_device_shared') == 'Yes' ? 'selected' : '' }}>Yes</option>
                        <option value="No" {{ old('student_device_shared') == 'No' ? 'selected' : '' }}>No</option>
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select id="field_student_reliable_internet" name="student_reliable_internet" class="form-select">
                        <option value="">Select</option>
                        <option value="Yes" {{ old('student_reliable_internet') == 'Yes' ? 'selected' : '' }}>Yes</option>
                        <option value="No" {{ old('student_reliable_internet') == 'No' ? 'selected' : '' }}>No</option>
                    </select>
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_internet_provider">Internet Provider</label>
                    <input type="text" id="field_student_internet_provider" name="student_internet_provider" class="form-control" value="{{ old('student_internet_provider') }}" placeholder="Provider name">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_student_online_tools">Online Tools</label>
                    <input type="text" id="field_student_online_tools" name="student_online_tools" class="form-control" value="{{ old('student_online_tools') }}" placeholder="Online tools used">
                </div>
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" id="field_mother_name" name="mother_name" class="form-control" value="{{ old('mother_name') }}" placeholder="Full name">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" id="field_mother_identification_type" name="mother_identification_type" class="form-control" value="{{ old('mother_identification_type') }}" placeholder="ID Type">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_mother_identification_number">Identification Number</label>
                    <input type="text" id="field_mother_identification_number" name="mother_identification_number" class="form-control" value="{{ old('mother_identification_number') }}" placeholder="ID Number">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_mother_contact">Contact Number</label>
                    <input type="tel" inputmode="tel" id="field_mother_contact" name="mother_contact" class="form-control" value="{{ old('mother_contact') }}" placeholder="Contact">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_mother_email">Email</label>
                    <input type="email" id="field_mother_email" name="mother_email" class="form-control" value="{{ old('mother_email') }}" placeholder="Email">
                </div>

                <div class="col-md-12">
                    <label class="form-label" for="field_mother_home_address">Home Address</label>
                    <textarea id="field_mother_home_address" name="mother_home_address" class="form-control" rows="2" placeholder="Home address">{{ old('mother_home_address') }}</textarea>
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="field_mother_profession">Profession</label>
                    <input type="text" id="field_mother_profession" name="mother_profession" class="form-control" value="{{ old('mother_profession') }}" placeholder="Profession">
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="field_mother_work_address">Work Address</label>
                    <textarea id="field_mother_work_address" name="mother_work_address" class="form-control" rows="2" placeholder="Work address">{{ old('mother_work_address') }}</textarea>
                </div>
        ...
        <fieldset>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" id="field_father_name" name="father_name" class="form-control" value="{{ old('father_name') }}" placeholder="Full name">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" id="field_father_identification_type" name="father_identification_type" class="form-control" value="{{ old('father_identification_type') }}" placeholder="ID Type">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_father_identification_number">Identification Number</label>
                    <input type="text" id="field_father_identification_number" name="father_identification_number" class="form-control" value="{{ old('father_identification_number') }}" placeholder="ID Number">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_father_contact">Contact Number</label>
                    <input type="tel" inputmode="tel" id="field_father_contact" name="father_contact" class="form-control" value="{{ old('father_contact') }}" placeholder="Contact">
                </div>

                <div class="col-md-4">
                    <label class="form-label" for="field_father_email_address">Email</label>
                    <input type="email" id="field_father_email_address" name="father_email_address" class="form-control" value="{{ old('father_email_address') }}" placeholder="Email">
                </div>

                <div class="col-md-12">
                    <label class="form-label" for="field_father_home_address">Home Address</label>
                    <textarea id="field_father_home_address" name="father_home_address" class="form-control" rows="2" placeholder="Home address">{{ old('father_home_address') }}</textarea>
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="field_father_profession">Profession</label>
                    <input type="text" id="field_father_profession" name="father_profession" class="form-control" value="{{ old('father_profession') }}" placeholder="Profession">
                </div>

                <div class="col-md-6">
                    <label class="form-label" for="field_father_work_address">Work Address</label>
                    <textarea id="field_father_work_address" name="father_work_address" class="form-control" rows="2" placeholder="Work address">{{ old('father_work_address') }}</textarea>
                </div>
        ...
        <fieldset>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" id="field_emergency_contact_name" name="emergency_contact_name" class="form-control" value="{{ old('emergency_contact_name') }}" placeholder="Full name">
                </div>

                <div class="col-md-3">
                    <label class="form-label" for="field_emergency_contact_relation_to_student">Relationship to Student</label>
                    <input type="text" id="field_emergency_contact_relation_to_student" name="emergency_contact_relation_to_student" class="form-control" value="{{ old('emergency_contact_relation_to_student') }}" placeholder="Relation">
                </div>

                <div class="col-md-3">
                    <label class="form-label" for="field_emergency_contact_number">Contact Number</label>
                    <input type="tel" inputmode="tel" id="field_emergency_contact_number" name="emergency_contact_number" class="form-control" value="{{ old('emergency_contact_number') }}" placeholder="Phone">
                </div>

                <div class="col-md-12">
                    <label class="form-label" for="field_emergency_contact_address">Address</label>
                    <textarea id="field_emergency_contact_address" name="emergency_contact_address" class="form-control" rows="2" placeholder="Emergency contact address">{{ old('emergency_contact_address') }}</textarea>
                </div>
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="date" id="field_registration_date" name="registration_date" class="form-control" value="{{ old('registration_date', date('Y-m-d')) }}">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="field_registrant_name" name="registrant_name" class="form-control" value="{{ old('registrant_name') }}" placeholder="Person registering">
                </div>

                <div class="col-md-3">
                    <label class="form-label" for="field_registrant_identification_type">Identification Type</label>
                    <input type="text" id="field_registrant_identification_type" name="registrant_identification_type" class="form-control" value="{{ old('registrant_identification_type') }}" placeholder="ID Type">
                </div>

                <div class="col-md-3">
                    <label class="form-label" for="field_registrant_identification_number">Identification Number</label>
                    <input type="text" id="field_registrant_identification_number" name="registrant_identification_number" class="form-control" value="{{ old('registrant_identification_number') }}" placeholder="ID Number">
                </div>

                <div class="col-md-3">
                    <label class="form-label" for="field_registrant_nationality">Nationality</label>
                    <input type="text" id="field_registrant_nationality" name="registrant_nationality" class="form-control" value="{{ old('registrant_nationality') }}" placeholder="Nationality">
                </div>

                <div class="col-md-3">
                    <label class="form-label" for="field_registrant_email">Email</label>
                    <input type="email" id="field_registrant_email" name="registrant_email" class="form-control" value="{{ old('registrant_email') }}" placeholder="Email">
                </div>
            </div>
        </fieldset>
