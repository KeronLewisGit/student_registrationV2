        ...
        <fieldset>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-5">
                    ...
                    <input type="text" name="student_first_name" class="form-control" value="{{ old('student_first_name', $student->student_first_name') }}" placeholder="First Name">
                </div>

                <div class="col-md-5">
                    <label class="form-label">Last Name</label>
                    <input type="text" name="student_last_name" class="form-control" value="{{ old('student_last_name', $student->student_last_name') }}" placeholder="Last Name">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="student_dob" class="form-control" value="{{ old('student_dob', $student->student_dob') }}">
                </div>
        ...
        <fieldset>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="date" name="student_sea_date" class="form-control" value="{{ old('student_sea_date', $student->student_sea_date') }}">
                </div>
        ...
        <fieldset>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="student_transfer_date" class="form-control" value="{{ old('student_transfer_date', $student->student_transfer_date') }}">
                </div>
