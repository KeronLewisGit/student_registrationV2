...
father_name, father_identification_type, father_identification_number, father_address_line1, father_city, father_village, father_contact, father_profession, father_work_address_line1, father_work_city, father_work_village,
...
VALUES (:student_passport_photo, :student_form, :student_name, :student_gender, :student_address_line1, :student_village, :student_city, :student_dob, :student_birth_certificate, :student_birth_certficate_pin,
:student_religion, :student_country_of_birth, :student_nationality, :student_contact, :student_email, :student_sea_date, :student_primary_school, :student_sea_slip, :student_sea_number, :student_medical_condition, :student_bloodtype,
:student_allergies, :student_immunization_status, :student_school_feeding_option, :student_social_welfare_status, :student_mode_of_transport, :student_access_to_device, :is_mother_active_or_deceased, :mother_name, :mother_identification_type,
:mother_identification_number, :mother_address_line1, :mother_city, :mother_village, :mother_contact, :mother_profession, :mother_work_address_line1, :mother_work_city, :mother_work_village, :mother_email, :is_father_active_or_deceased,
:father_name, :father_identification_type, :father_identification_number, :father_address_line1, :father_city, :father_village, :father_contact, :father_profession, :father_work_address_line1, :father_work_city, :father_work_village,
...
$stmt->execute([
  ...
  ":mother_city" => $_POST['fields']['mother_city']['value'],
  ":mother_village" => $_POST['fields']['mother_village']['value'],
  ":mother_contact" => $_POST['fields']['mother_contact']['value'],
  ":mother_profession" => $_POST['fields']['mother_profession']['value'],
  ":mother_work_address_line1" => $_POST['fields']['mother_work_address_line1']['value'],
  ":mother_work_city" => $_POST['fields']['mother_work_city']['value'],
  ...
  ":father_city" => $_POST['fields']['father_city']['value'],
  ":father_village" => $_POST['fields']['father_village']['value'],
  ":father_contact" => $_POST['fields']['father_contact']['value'],
  ":father_profession" => $_POST['fields']['father_profession']['value'],
  ":father_work_address_line1" => $_POST['fields']['father_work_address_line1']['value'],
